...
public class WeatherDao_Impl implements WeatherDao {
  ...
  @Override
  public void bulkInsert(WeatherEntry... arg0) {
  ...
  @Override
  public void deleteOldWeather(Date arg0) {
    final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteOldWeather.acquire();
    __db.beginTransaction();
    try {
      int _argIndex = 1;
      final Long _tmp;
      _tmp = __dateConverter.toTimestamp(arg0);
      if (_tmp == null) {
  ...
  @Override
  public LiveData<WeatherEntry> getWeatherByDate(Date arg0) {
      ...
      protected WeatherEntry compute() {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            _tmpDate = __dateConverter.toDate(_tmp_1);
  ...
  @Override
  public int countAllFutureWeather(Date arg0) {
  ...
  @Override
  public LiveData<List<ListWeatherEntry>> getAllWeathers(Date arg0) {
